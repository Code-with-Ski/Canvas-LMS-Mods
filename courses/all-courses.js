            ...
            if (columnCells) {
              ...
              if (values.length > 1) {
                ...
                columnHeader.innerHTML = `
                    <button class="ski-courses-column-sort-btn" data-ski-sort-dir="none">
                      ${headingName}
                    </button>
                  `;
                ...
                if (columnSortButton) {
                  columnSortButton.addEventListener("click", () => {
                    ...
                    const sortButtons = [...document.querySelectorAll(`#${courseTableId} thead th:not(.${columnNameClass}) button.ski-courses-column-sort-btn`)];
